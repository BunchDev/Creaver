...
<div align="center" id="icon_search" class=".col-md-8">	
<section class="main">				
	<div id="presentacion" class="arc-wrapper">
		<h3 id="letrero_abi">Aprendizaje Basado en Investigación</h3>
...
@if(isset($datos))
	...
	@if($datos->tipo == 1)
		<label >PREGUNTA GENERADORA</label>
		<br>
		<p class="p_generador">{{$datos->generador}} <p>
	@else
		<label>CASO: </label>
		<p class="p_generador">{{$datos->generador}}	<p>
	@endif
...
$("#icon_search").addClass('magictime tinUpIn');
 fn();		
});
